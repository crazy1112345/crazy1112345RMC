...
public abstract class SharedDisguiseItemSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<DisguiseItemComponent, GotEquippedEvent>(OnGotEquipped);
        SubscribeLocalEvent<DisguiseItemComponent, GotUnequippedEvent>(OnGotUnequipped);
        SubscribeLocalEvent<DisguiseItemComponent, GetVerbsEvent<InteractionVerb>>(OnVerb);
    }

    private void OnGotEquipped(EntityUid uid, DisguiseItemComponent component, GotEquippedEvent args)
    {
        component.User = args.Equipee;
    }

    private void OnGotUnequipped(EntityUid uid, DisguiseItemComponent component, GotUnequippedEvent args)
    {
        component.User = null;
    }
    ...
    protected void UpdateVisuals(EntityUid uid, DisguiseItemComponent component)
    {
    ...
    private void OnVerb(Entity<DisguiseItemComponent> ent, ref GetVerbsEvent<InteractionVerb> args)
    {
        ...
        args.Verbs.Add(new InteractionVerb()
        {
            ...
            Act = () => UI.TryToggleUi(ent.Owner, DisguiseUiKey.Key, user)
        });
    }
