...
public sealed class DisguiseItemSystemSystem : SharedDisguiseItemSystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<DisguiseItemComponent, AfterAutoHandleStateEvent>(HandleState);
    ...
    private void HandleState(EntityUid uid, DisguiseItemComponent component, ref AfterAutoHandleStateEvent args)
    {
